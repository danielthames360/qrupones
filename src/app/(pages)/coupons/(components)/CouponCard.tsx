...
export const CouponCard = ({ img, name, description, date, button }: CouponCardProps) => {
  return (
    <div className='flex items-center coupon'>
        <Image src={img} alt='icon-business' className='max-w-[7rem] mr-[20px] h-auto sm:max-w-[10rem] md:max-w-[8rem] xl:max-w-[10rem]'/> 

      <div className='flex flex-col items-start border-dashed border-t-0 border-r-0 border-b-0 border-[#66666678] pl-10 py-3 gap-4 md:gap-5'>
